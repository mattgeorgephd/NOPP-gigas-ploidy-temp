...
BSA_results<-mutate(samples_BSA, protein_content, weights, standardization)
...
CS_activity_10uL<-(GSH_10/(t*V1))*D/BSA_10$protein_content
CS_activity_20uL<-(GSH_20/(t*V2))*D/BSA_20$protein_content
...
results_10uL<-mutate(initial_10, OD=deltaOD_10, GSH=GSH_10, weights=weights_10$weights, standardized=BSA_10$standardization, "Protein (mg/ul)"=BSA_10$protein_content, "CS activity (nmol/(mg*min))"=CS_activity_10uL) #OD is the delta OD for the samples
results_20uL<-mutate(initial_20, OD=deltaOD_20, GSH=GSH_20, weights=weights_20$weights, standardized=BSA_20$standardization, "Protein (mg/ul)"=BSA_20$protein_content, "CS activity (nmol/(mg*min))"=CS_activity_20uL) #OD is the delta OD for the samples
