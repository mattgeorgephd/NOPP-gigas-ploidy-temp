...
names(CS_6)[7]<-'Label'
names(CS_6)[6]<-'A'
wells<-c(0, 8, 16, 24, 32, 40, "pos","pos", "pos", "background", "background", "background", "X47", "X47", "X47", NA, "T61", "T61", NA, "X42", "X42", "N57", NA, "N57", NA, "X48", "X48", "R42", "R42", "R42", NA, "X43", "X43", "X44", "X44", "X44", "D55", NA, "D55", NA, "M47", "M47", "N44", "N44", "N44", NA, "D59", "D59", "R51", "R51", "R51", "T56", "T56", "T56", NA, "R60", "R60", "M41", "M41", "M41", "R46", "R46", "R46", "M89",	"M89",	"M89", NA, "T58", "T58", "R48", "R48", "R48", "T62", "T62", "T62") #NAs are where bubbles affected the results 
...
protein_content<-(2900*samples_BSA$meanA)-1900 #with no correction, y=-1900 +2900x
