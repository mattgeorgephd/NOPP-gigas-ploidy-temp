...
---
Coding Resources for paper named "Citrate-Synthase Response and Multilpe-Stress in Pacific Oysters" authored by Olivia Cattau, Matt George and Steven Roberts
...
Full_data3 %>%
  group_by(trt_short) %>%
  summarise(avg = mean(CS_activity))
```
