...
#direct GLM
morphANOVA<-lm(filtered_morph$CS.activity..nmol..mg.min..~filtered_morph$ploidy.trt+ filtered_morph$shell_volume+shell_length+shell_width+shell_height+sample_date+calc_dry_weight+filtered_morph$ploidy+filtered_morph$trt+date.of.sample)
...
#interactions
morphANOVA2<-lm(filtered_morph$CS.activity..nmol..mg.min..~filtered_morph$ploidy.trt* filtered_morph$shell_volume*shell_length+shell_width*shell_height+sample_date*calc_dry_weight*filtered_morph$ploidy*filtered_morph$trt*date.of.sample)
anova(morphANOVA2)
