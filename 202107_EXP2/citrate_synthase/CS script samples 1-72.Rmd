...
oysterANOVA<-lm(results_unique$CS.activity..nmol..mg.min.. ~ trt, data=results_unique)#Citrate Synthase response to treatment explanatory
oysterANOVA2<-lm(results_unique$CS.activity..nmol..mg.min..~ploidy, data=results_unique) # Citrate Synthase response to ploidy explanatory

anova(oysterANOVA) #heat treatment is having a significant effect on CS results 
...
trt_date #non-random distribution, pull it out of analysis so only trt and ploidy+trt are signficant
...
filtered_morph
oysterANOVA3<-lm(filtered_morph$calc_dry_weight~filtered_morph$ploidy.trt)
anova(oysterANOVA3)#not significant
cdw_table<-TukeyHSD(aov(oysterANOVA3))
...
- calculated dry weight was not significant in regards to treatment response
