...
protein_content<-(2900*A_samples$meanA)-2400 #with no correction
protein_content[protein_content < 250]<-NA #<250 ug/mL is out of range for BSA
protein_content[protein_content > 1500]<-NA #P>1500 is out of range for BSA
