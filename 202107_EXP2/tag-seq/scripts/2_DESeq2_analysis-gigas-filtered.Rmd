...
load.lib<-c("DESeq2","edgeR","goseq","dplyr","GenomicFeatures","data.table","calibrate","affycoretools","data.table","vsn","tidybulk","ggplot2","cowplot","pheatmap","gplots","RColorBrewer","EnhancedVolcano","pcaExplorer","readxl","apeglm","ashr","tibble","plotly","sqldf","PCAtools","ggpubr","beepr","genefilter","ComplexHeatmap","circlize")
...
png(filename = "output/control_ploidy/control_ploidy_gene_heatmap.png", 
...
ggexport(filename = "CONTROL-PLOIDY-BIPLOT.png",
         plot   = bp0,
         res    = 600,
         width  = 4000,
         height = 5000)
...
# Save plots
ggsave("output/control_ploidy/Volcano_all_genes.png",
       plot   = p1,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/control_ploidy/Volcano_all_genes_normal.png",
       plot   = p2,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/control_ploidy/Volcano_all_genes_ashr.png",
       plot   = p3,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/control_ploidy/Volcano_all_genes_apeglm.png",
       plot   = p4,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/control_ploidy/Volcano_sig_genes.png",
       plot   = p5,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/control_ploidy/Volcano_sig_genes_normal.png",
       plot   = p6,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/control_ploidy/Volcano_sig_genes_ashr.png",
       plot   = p7,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/control_ploidy/Volcano_sig_genes_apeglm.png",
       plot   = p8,
       dpi    = 600,
       device = "png",
       width  = 6,
...
# Remove genes w/ uncharacterized and/or low quality proteins from plot
grx <- glob2rx("unchar*")
sigs_uncharacterized <- with(sigs, subset(sigs, subset = grepl(grx, description)))
sigs_characterized   <- anti_join(sigs, sigs_uncharacterized, by = 'gene')
grx <- glob2rx("LOW*")
sigs_uncharacterized <- with(sigs_characterized, subset(sigs_characterized, subset = grepl(grx, description)))
sigs_characterized   <- anti_join(sigs_characterized, sigs_uncharacterized, by = 'gene')
...
png(filename = "output/heat_ploidy/heat_ploidy_gene_heatmap.png", 
    res = 600, width = 6000, height = 4000, units = "px", pointsize = 6)
# par(mar=c(5,8,4,1)+.1)
print(h)
dev.off()
...
ggexport(filename = "HEAT-PLOIDY-BIPLOT.png",
         plot   = bp0,
         res    = 600,
         width  = 4000,
         height = 5000)
...
ggsave("output/heat_ploidy/Volcano_all_genes.png",
       plot   = p1,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/heat_ploidy/Volcano_all_genes_normal.png",
       plot   = p2,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/heat_ploidy/Volcano_all_genes_ashr.png",
       plot   = p3,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/heat_ploidy/Volcano_all_genes_apeglm.png",
       plot   = p4,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/heat_ploidy/Volcano_sig_genes.png",
       plot   = p5,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/heat_ploidy/Volcano_sig_genes_normal.png",
       plot   = p6,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/heat_ploidy/Volcano_sig_genes_ashr.png",
       plot   = p7,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/heat_ploidy/Volcano_sig_genes_apeglm.png",
       plot   = p8,
       dpi    = 600,
       device = "png",
       width  = 6,
...
png(filename = "output/desiccation_ploidy/desiccation_ploidy_gene_heatmap.png", 
    res = 600, width = 6000, height = 4000, units = "px", pointsize = 6)
# par(mar=c(5,8,4,1)+.1)
print(h)
dev.off()
...
ggexport(filename = "DESICCATION-PLOIDY-BIPLOT.png",
         plot   = bp0,
         res    = 600,
         width  = 4000,
         height = 5000)
...
ggsave("output/desiccation_ploidy/Volcano_all_genes.png",
       plot   = p1,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/desiccation_ploidy/Volcano_all_genes_normal.png",
       plot   = p2,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/desiccation_ploidy/Volcano_all_genes_ashr.png",
       plot   = p3,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/desiccation_ploidy/Volcano_all_genes_apeglm.png",
       plot   = p4,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/desiccation_ploidy/Volcano_sig_genes.png",
       plot   = p5,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/desiccation_ploidy/Volcano_sig_genes_normal.png",
       plot   = p6,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/desiccation_ploidy/Volcano_sig_genes_ashr.png",
       plot   = p7,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/desiccation_ploidy/Volcano_sig_genes_apeglm.png",
       plot   = p8,
       dpi    = 600,
       device = "png",
       width  = 6,
...
png(filename = "output/diploid_heat/diploid_heat_gene_heatmap.png", 
    res = 600, width = 6000, height = 4000, units = "px", pointsize = 6)
# par(mar=c(5,8,4,1)+.1)
print(h)
dev.off()
...
ggexport(filename = "DIPLOID-HEAT-BIPLOT.png",
         plot   = bp0,
         res    = 600,
         width  = 4000,
         height = 5000)
...
ggsave("output/diploid_heat/Volcano_all_genes.png",
       plot   = p1,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/diploid_heat/Volcano_all_genes_normal.png",
       plot   = p2,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/diploid_heat/Volcano_all_genes_ashr.png",
       plot   = p3,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/diploid_heat/Volcano_all_genes_apeglm.png",
       plot   = p4,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/diploid_heat/Volcano_sig_genes.png",
       plot   = p5,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/diploid_heat/Volcano_sig_genes_normal.png",
       plot   = p6,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/diploid_heat/Volcano_sig_genes_ashr.png",
       plot   = p7,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/diploid_heat/Volcano_sig_genes_apeglm.png",
       plot   = p8,
       dpi    = 600,
       device = "png",
       width  = 6,
...
png(filename = "output/diploid_desiccation/diploid_desiccation_gene_heatmap.png", 
    res = 600, width = 6000, height = 4000, units = "px", pointsize = 6)
# par(mar=c(5,8,4,1)+.1)
print(h)
dev.off()
...
ggexport(filename = "DIPLOID-DESICCATION-BIPLOT.png",
         plot   = bp0,
         res    = 600,
         width  = 4000,
         height = 5000)
...
ggsave("output/diploid_desiccation/Volcano_all_genes.png",
       plot   = p1,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/diploid_desiccation/Volcano_all_genes_normal.png",
       plot   = p2,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/diploid_desiccation/Volcano_all_genes_ashr.png",
       plot   = p3,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/diploid_desiccation/Volcano_all_genes_apeglm.png",
       plot   = p4,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/diploid_desiccation/Volcano_sig_genes.png",
       plot   = p5,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/diploid_desiccation/Volcano_sig_genes_normal.png",
       plot   = p6,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/diploid_desiccation/Volcano_sig_genes_ashr.png",
       plot   = p7,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/diploid_desiccation/Volcano_sig_genes_apeglm.png",
       plot   = p8,
       dpi    = 600,
       device = "png",
       width  = 6,
...
sigs_characterized   <- anti_join(sigs_characterized, sigs_uncharacterized, by = 'gene')
grx <- glob2rx("LOCNA*")
sigs_uncharacterized <- with(sigs_characterized, subset(sigs_characterized, subset = grepl(grx, gene)))
sigs_characterized   <- anti_join(sigs_characterized, sigs_uncharacterized, by = 'gene')
...
png(filename = "output/triploid_heat/triploid_heat_gene_heatmap.png", 
    res = 600, width = 6000, height = 4000, units = "px", pointsize = 6)
# par(mar=c(5,8,4,1)+.1)
print(h)
dev.off()
...
ggexport(filename = "TRIPLOID-HEAT-BIPLOT.png",
         plot   = bp0,
         res    = 600,
         width  = 4000,
         height = 5000)
...
ggsave("output/triploid_heat/Volcano_all_genes.png",
       plot   = p1,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/triploid_heat/Volcano_all_genes_normal.png",
       plot   = p2,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/triploid_heat/Volcano_all_genes_ashr.png",
       plot   = p3,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/triploid_heat/Volcano_all_genes_apeglm.png",
       plot   = p4,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/triploid_heat/Volcano_sig_genes.png",
       plot   = p5,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/triploid_heat/Volcano_sig_genes_normal.png",
       plot   = p6,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/triploid_heat/Volcano_sig_genes_ashr.png",
       plot   = p7,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/triploid_heat/Volcano_sig_genes_apeglm.png",
       plot   = p8,
       dpi    = 600,
       device = "png",
       width  = 6,
...
png(filename = "output/triploid_desiccation/triploid_desiccation_gene_heatmap.png", 
    res = 600, width = 6000, height = 4000, units = "px", pointsize = 6)
# par(mar=c(5,8,4,1)+.1)
print(h)
dev.off()
...
ggexport(filename = "TRIPLOID-DESICCATION-BIPLOT.png",
         plot   = bp0,
         res    = 600,
         width  = 4000,
         height = 5000)
...
ggsave("output/triploid_desiccation/Volcano_all_genes.png",
       plot   = p1,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/triploid_desiccation/Volcano_all_genes_normal.png",
       plot   = p2,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/triploid_desiccation/Volcano_all_genes_ashr.png",
       plot   = p3,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/triploid_desiccation/Volcano_all_genes_apeglm.png",
       plot   = p4,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/triploid_desiccation/Volcano_sig_genes.png",
       plot   = p5,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/triploid_desiccation/Volcano_sig_genes_normal.png",
       plot   = p6,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/triploid_desiccation/Volcano_sig_genes_ashr.png",
       plot   = p7,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("output/triploid_desiccation/Volcano_sig_genes_apeglm.png",
       plot   = p8,
       dpi    = 600,
       device = "png",
       width  = 6,
