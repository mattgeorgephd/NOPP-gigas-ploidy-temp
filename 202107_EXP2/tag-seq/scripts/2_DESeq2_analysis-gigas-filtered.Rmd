...
# Pheatmap: R53?, old - M43, N57, R53, R62, T62, X42, X44
coldata <- coldata[!(row.names(coldata) %in% c('D54','N56', 'X44')),]
cts <- as.matrix(subset(cts, select=-c(D54, N56, X44)))
...
bp0 <- biplot(p, showLoadings = TRUE, colby = 'group',
