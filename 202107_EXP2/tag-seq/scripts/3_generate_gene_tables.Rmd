...
diploid_MS_unique <- read.delim("output/filtered/HISAT2_multiqc_biplot/DEG_diploid_multi_unique.csv", sep = " ", header = TRUE)
diploid_MS_unique <- diploid_MS_unique %>% select(gene, padj, log2FoldChange, description)

triploid_MS_unique <- read.delim("output/filtered/HISAT2_multiqc_biplot/DEG_triploid_multi_unique.csv", sep = " ", header = TRUE)
...
write.table(diploid_MS_unique,    file = "gene_tables/filtered/HISAT2_multiqc_biplot/diploid_MS_unique.txt", sep = "\t", quote = FALSE, row.names = F)
write.table(triploid_MS_unique,   file = "gene_tables/filtered/HISAT2_multiqc_biplot/triploid_MS_unique.txt", sep = "\t", quote = FALSE, row.names = F)
...
write.table(diploid_MS_unique_characterized,        file = "gene_tables/filtered/HISAT2_multiqc_biplot/diploid_MS_unique_characterized.txt",        sep = "\t", quote = FALSE, row.names = F)
write.table(triploid_MS_unique_characterized, file = "gene_tables/filtered/HISAT2_multiqc_biplot/triploid_MS_unique_characterized.txt", sep = "\t", quote = FALSE, row.names = F)
...
write.table(diploid_MS_unique_uncharacterized,    file = "gene_tables/filtered/HISAT2_multiqc_biplot/diploid_MS_unique_uncharacterized.txt",    sep = "\t", quote = FALSE, row.names = F)
write.table(triploid_MS_unique_uncharacterized, file = "gene_tables/filtered/HISAT2_multiqc_biplot/triploid_MS_unique_uncharacterized.txt",     sep = "\t", quote = FALSE, row.names = F)
