...
# Assign factors
dat_stat$trt  <- factor(dat_stat$group)

# Select test variable
test_me <- dat_stat$temp_mean
...
my_test <- aov(response ~ hour * group, data = dat_stat)
...
linear_model <- lm(max_temp ~ shell_volume, data=oyster_plot)
