...
# calculate mean +/e sE
SMR_mean <- resp_plot_overview %>% summary_se(SMR_weight, # response variable
...
ggsave("analyses/respiration/overview.png",
       plot   = p4,
       dpi    = 1200,
       device = "png",
       width  = 4,
...
# save output
write.table(my_test_summary$`Error: Within`[[1]], file = "stats/AOV_respirometry.csv",      row.names = TRUE)
write.table(mult_comp$groups,                     file = "stats/HSD_test_respirometry.csv", row.names = TRUE)
